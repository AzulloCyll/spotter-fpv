          ...
          <ScrollView style={dynamicStyles.content} showsVerticalScrollIndicator={false}>
            <View style={dynamicStyles.powerSection}>
              <View style={dynamicStyles.powerCard}>
                <View style={dynamicStyles.powerItem}>
                  ...
                  <View style={dynamicStyles.bigValueRow}>
                    <Typography variant="h1" style={dynamicStyles.bigValue}>
                      {battery.voltage}
                    </Typography>
                    <Typography variant="h2" color="textSecondary" style={dynamicStyles.bigUnit}>
                      V
                    </Typography>
                  </View>
                </View>
              ...
              <View style={dynamicStyles.progressBarBg}>
                <View
                  style={[dynamicStyles.progressBarFill, { width: `${battery.percentage}%` }]}
                />
              </View>
            </View>
            ...
            <View style={dynamicStyles.gridSection}>
              <View style={dynamicStyles.gridRow}>
                <DataTile
                  ...
                  label="Sygnał RSSI"
                  value={signal.rssi.toString()}
                  unit="dBm"
                />
                <DataTile
                  icon={<Icon name="Activity" />}
                  label="Jakość LQ"
                  value={signal.lq.toString()}
                  unit="%"
                />
              </View>
              <View style={dynamicStyles.gridRow}>
                ...
                <DataTile
                  ...
                  label="Prędkość"
                  value={gps.speed.toString()}
                  unit="km/h"
                />
              </View>
              <View style={dynamicStyles.gridRow}>
                <DataTile
                  icon={<Icon name="Navigation2" />}
                  label="Wysokość"
                  value={gps.altitude.toString()}
                  unit="m"
                />
                <DataTile
                  icon={<Icon name="Compass" />}
                  label="Kurs"
                  value={gps.course.toString()}
                  unit="°"
                />
              </View>
              <View style={dynamicStyles.gridRow}>
                <DataTile
                  ...
                  label="VTX Temp"
                  value={vtxTemp.toString()}
                  unit="°C"
                  isCritical={vtxTemp > 80}
                />
                <DataTile
                  icon={<Icon name="Cpu" />}
                  label="CPU Res"
                  value={cpuRes.toString()}
                  unit="%"
                />
              </View>
            </View>
            ...
            >
              ...
              <View style={dynamicStyles.gpsContent}>
                <Typography variant="body" color="textSecondary" style={dynamicStyles.gpsLabel}>
                  Ostatnia znana pozycja
                </Typography>
                <Typography variant="h2" style={dynamicStyles.gpsCoords}>
                  {gps.lat.toFixed(6)}, {gps.lng.toFixed(6)}
                </Typography>
              </View>
              <View style={dynamicStyles.gpsAction}>
                <Typography variant="label" color="primary" weight="900" style={{ fontSize: 12 }}>
                  MAPA
                </Typography>
              </View>
            </TouchableOpacity>
