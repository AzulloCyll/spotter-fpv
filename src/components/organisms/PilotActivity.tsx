...
const MOCK_ACTIVITY = [
  {
    ...
    pilot: 'Piotr_FPV',
    action: 'napisał',
    message: 'Ktoś dziś lata na Bemowie? Pogoda wygląda idealnie!',
    time: '2m',
    avatar:
  ...
  },
  {
    ...
    pilot: 'Droniarz',
    action: 'odpowiedział',
    message: 'Będę za 20 minut, biorę 5 pakietów. Widzimy się przy lądowisku!',
    time: '1m',
    avatar:
  ...
  },
  {
    id: '5',
    pilot: 'FPV_Racer',
    action: 'dołączył do rozmowy',
    message: 'Uważajcie na wiatr od zachodu, na górze trochę rzuca.',
    time: '30m',
    avatar:
  ...
  {
    id: '6',
    pilot: 'Cinematic_Flow',
    action: 'wrzucił film 4K',
    spot: 'Tatry',
    time: '3h',
    image:
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Typography variant="bodySmall" color="primary" weight="700">
          CZAT
        </Typography>
      </View>
      ...
      >
        {MOCK_ACTIVITY.map((item) => (
          <View
            key={item.id}
            style={[styles.item, isDark && { backgroundColor: 'rgba(255,255,255,0.05)' }]}
          >
            ...
            <View style={styles.content}>
              <View style={styles.itemHeader}>
                <Typography
                  variant="h3"
                  style={{ fontWeight: '700', fontSize: 13, color: theme.colors.text }}
                >
                  {item.pilot}{' '}
                  <Typography
                    variant="bodySmall"
