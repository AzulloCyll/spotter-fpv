      ...
      >
        ...
        <View style={dynamicStyles.photoOverlay}>
          <View style={dynamicStyles.likeBadge}>
            ...
            <Typography
              variant="caption"
              style={{ color: theme.colors.white, marginLeft: 4, fontSize: 10 }}
            >
              {item.likes}
            </Typography>
          </View>
    ...
    <View style={dynamicStyles.container}>
          ...
          !isUploading ? (
            <View
              style={[
                ...
                {
                  backgroundColor: isDark ? theme.colors.white + '08' : theme.colors.border + '33',
                },
              ]}
            >
      ...
      >
        ...
        <View style={dynamicStyles.modalOverlay}>
          <Pressable style={dynamicStyles.modalBackground} onPress={() => setSelectedPhoto(null)} />
          ...
          <View style={dynamicStyles.modalContent}>
            ...
            <View style={dynamicStyles.modalFooter}>
              <TouchableOpacity
                style={[
                  dynamicStyles.modalAction,
                  activePhoto?.isLiked && { backgroundColor: theme.colors.error + '33' },
                ]}
