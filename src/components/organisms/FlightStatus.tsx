    ...
    <View style={dynamicStyles.wrapper}>
      <View style={dynamicStyles.container}>
        ...
        >
          <Icon
            name="Radar"
            color={isLinkActive ? theme.colors.success : theme.colors.error}
            size={64}
            strokeWidth={1.2}
          />
        </View>
        ...
        <Typography
          variant="h3"
          style={[dynamicStyles.title, { color: isLinkActive ? theme.colors.success : textColor }]}
        >
        ...
        <Typography
          variant="bodySmall"
          style={[dynamicStyles.telemetry, { color: secondaryColor }]}
        >
