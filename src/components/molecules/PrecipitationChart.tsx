        ...
        <View style={styles.container}>
            <View style={[styles.chartHeader, {
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Typography variant="h3" style={{ marginLeft: 8 }}>Opady</Typography>
                </View>
                <View style={{ alignItems: 'flex-end' }}>
                    <Typography variant="label" style={{ fontSize: 10, fontWeight: '800', lineHeight: 12 }}>Ilość [mm]</Typography>
                    <Typography variant="caption" color="textSecondary" style={{ fontSize: 11, lineHeight: 12 }}>Szansa [%]</Typography>
                </View>
            </View>
                                    ...
                                    <View
                                        style={[
                                            styles.bar,
                                            {
                                                ...
                                                backgroundColor: hasAmount ? theme.colors.primary : theme.colors.textSecondary,
