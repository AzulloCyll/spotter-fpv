...
export const MOCK_SPOTS: Spot[] = [
  ...
  },
  {
    ...
    description: 'Duży park w centrum. Uwaga na spacerowiczów i psy! Latać tylko rano lub w nocy.',
    type: 'park',
    difficulty: 'easy',
    coordinates: {
      latitude: 52.219,
  ...
  },
  {
    ...
    description: 'Techniczne latanie między filarami mostu. Wymagany dobry link wideo.',
    type: 'urban',
    difficulty: 'hard',
    coordinates: {
      latitude: 52.213,
  ...
  },
  {
    id: '4',
    name: 'Górka Kazurka',
    description: 'Popularne miejsce na Ursynowie. Otwarte pole, drzewa, czasem tory rowerowe.',
    type: 'nature',
    difficulty: 'medium',
    coordinates: {
      latitude: 52.1445,
  ...
  },
  {
    ...
    rating: 4.9,
    images: ['https://picsum.photos/300/200?random=6', 'https://picsum.photos/300/200?random=7'],
  },
];
