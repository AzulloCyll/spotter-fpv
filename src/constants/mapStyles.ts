...
/**
 * Radar opadów z RainViewer - bez klucza API. Adres kafla nie jest stały:
 * trzeba najpierw pobrać stąd `radar.past` i wziąć ścieżkę najnowszej klatki.
 * Robi to skrypt mapy w WebView.
 */
